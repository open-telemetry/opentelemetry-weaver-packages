...
| [`myapp.session.id`](/docs/registry/attributes/myapp.md) | ![Development](https://img.shields.io/badge/-development-blue) | `Recommended` | string | Unique identifier of the application session. | `sess_5j66Up` |
