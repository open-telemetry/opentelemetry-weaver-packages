...
Every template that produces a whole standalone output file (as opposed to a
macro/include file, or a snippet embedded into a handwritten doc) should mark
that output as generated, per Weaver's
[Mark generated files](https://github.com/open-telemetry/weaver/blob/main/docs/codegen.md#mark-generated-files)
guidance: a short header comment, in the target format's comment syntax,
saying the file is generated and which template it came from. See the
`<!-- NOTE: THIS FILE IS AUTOGENERATED. DO NOT EDIT BY HAND. -->` header in
`templates/docs/markdown/*.md.j2` for the convention already used in this repo.
